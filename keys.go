...
var DefaultKeyMap = KeyMap{
	...
	NextPane:        key.NewBinding(key.WithKeys("l", "tab", "right"), key.WithHelp("l", "navigate")),
	PreviousPane:    key.NewBinding(key.WithKeys("h", "shift+tab", "left"), key.WithHelp("h", "navigate")),
